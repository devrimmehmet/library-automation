...
{
    public partial class DeleteWithDescriptionBooks : Form
    {
        public DeleteWithDescriptionBooks()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dr.Read())
                {
                    ...
                    sqlConnection.Close();
                    sqlConnection.Open();
                    string DeletedBookStr = "DeleteFromBooks @ID,@DeletedInfo,@DeletedDate,@DeletedEmployeeID";
                    SqlCommand DeleteBook = new SqlCommand(DeletedBookStr, sqlConnection);
                    DeleteBook.Parameters.AddWithValue("@ID", DeletedID);
                    DeleteBook.Parameters.AddWithValue("@DeletedInfo", rTB_DeletedInfo.Text);
                    DeleteBook.Parameters.AddWithValue("@DeletedDate", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                    DeleteBook.Parameters.AddWithValue("@DeletedEmployeeID", DeletedEmployeeID);
