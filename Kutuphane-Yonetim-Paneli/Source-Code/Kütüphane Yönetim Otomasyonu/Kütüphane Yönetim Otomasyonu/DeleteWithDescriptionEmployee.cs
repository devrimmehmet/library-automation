...
{
    public partial class DeleteWithDescriptionEmployee : Form
    {
        public DeleteWithDescriptionEmployee()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Personel Silme Gerekçenizi bir kaç kelime ile açıklayınız.", "Boş Geçilemez", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else {
            sqlConnection.Open();
            ...
            if (dr.Read())
            {
                    ...
                    sqlConnection.Close();
                    if (DeletedID== DeletedEmployeeID)
                    {
                    ...
                    else
                    {
                        ...
                        sqlConnection.Open();
                        string DeletedMemberStr = "DeleteFromEmployees @ID,@DeletedInfo,@DeletedDate,@DeletedEmployeeID";
